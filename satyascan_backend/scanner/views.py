...
class ScanProfileView(APIView):
    ...
    def post(self, request):
        ...
        return Response({
            ...
            "profile_scanned":ProfileScan.objects.count(),
            "trusted_worldwide":True,
            "users_protected":1000,
            "uptime":"99.9%",
            "behavior_ai":"not_enabled",
            "image_forensic":"not_enabled",
            "always_on_monitoring":False,
